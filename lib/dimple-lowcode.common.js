...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".dimple-lowcode-conatiner[data-v-7ac1bec7]{height:100%;width:100%;overflow:hidden;display:flex;flex-direction:column;background:#f0f2f5}.header[data-v-7ac1bec7]{height:48px;background:#fff;display:flex;align-items:center;justify-content:center;padding:0 10px}.header .title[data-v-7ac1bec7]{font-weight:500}.selection[data-v-7ac1bec7]{flex:1;padding:5px}.material[data-v-7ac1bec7],.selection[data-v-7ac1bec7]{overflow:hidden;display:flex}.material[data-v-7ac1bec7]{width:25%;height:100%;background:#fff;flex-direction:column}.content[data-v-7ac1bec7]{flex:1;height:100%;overflow:overlay;margin:0 1%}.content-component-item[data-v-7ac1bec7]{height:100%;width:100%;overflow:hidden;position:relative}.content-component-item-mask[data-v-7ac1bec7]{position:absolute;height:100%;width:100%;z-index:1;box-sizing:border-box;text-align:right;padding:4px;padding-top:2px}.content-component-item-mask .icon[data-v-7ac1bec7]{display:none;color:#f56c6c}.content-component-item-mask[data-v-7ac1bec7]:hover{border:1px dashed rgba(21,59,184,.3);background:rgba(21,59,184,.05)}.content-component-item-mask:hover .icon[data-v-7ac1bec7]{display:inline-block;cursor:pointer}.content-component-item-mask-active[data-v-7ac1bec7]{border:1px dashed rgba(21,59,184,.3);background:rgba(21,59,184,.05)}.content-component-item-mask-active .icon[data-v-7ac1bec7]{display:inline-block;cursor:pointer}.options[data-v-7ac1bec7]{width:25%;height:100%;overflow:overlay;background:#fff}", ""]);
// Exports
...
var update = add("4ed55686", content, true, {"sourceMap":false,"shadowMode":false});
...
// load the styles
var content = __webpack_require__(9923);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(7037)/* ["default"] */ .Z)
var update = add("6a701c33", content, true, {"sourceMap":false,"shadowMode":false});
...
var DimpleLowcodevue_type_style_index_0_id_7ac1bec7_prod_scoped_true_lang_css_ = __webpack_require__(7602);
;// CONCATENATED MODULE: ./src/package/dimple-lowcode/src/DimpleLowcode.vue?vue&type=style&index=0&id=7ac1bec7&prod&scoped=true&lang=css&

// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/package/dimple-lowcode/src/DimpleLowcode.vue?vue&type=style&index=1&id=7ac1bec7&prod&lang=css&
var DimpleLowcodevue_type_style_index_1_id_7ac1bec7_prod_lang_css_ = __webpack_require__(4888);
;// CONCATENATED MODULE: ./src/package/dimple-lowcode/src/DimpleLowcode.vue?vue&type=style&index=1&id=7ac1bec7&prod&lang=css&
