...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".dimple-lowcode-conatiner[data-v-4aee4bda]{height:100%;width:100%;overflow:hidden;display:flex;flex-direction:column;background:#f0f2f5}.header[data-v-4aee4bda]{height:48px;background:#fff;display:flex;align-items:center;justify-content:center;padding:0 10px}.header .title[data-v-4aee4bda]{font-weight:500}.selection[data-v-4aee4bda]{flex:1;padding:5px}.material[data-v-4aee4bda],.selection[data-v-4aee4bda]{overflow:hidden;display:flex}.material[data-v-4aee4bda]{width:25%;height:100%;background:#fff;flex-direction:column}.content[data-v-4aee4bda]{flex:1;height:100%;overflow:overlay;margin:0 1%}.content-component-item[data-v-4aee4bda]{height:100%;width:100%;overflow:hidden;position:relative}.content-component-item-mask[data-v-4aee4bda]{position:absolute;height:100%;width:100%;z-index:1;box-sizing:border-box;text-align:right;padding:4px;padding-top:2px}.content-component-item-mask .icon[data-v-4aee4bda]{display:none;color:#f56c6c}.content-component-item-mask[data-v-4aee4bda]:hover{border:1px dashed rgba(21,59,184,.3);background:rgba(21,59,184,.05)}.content-component-item-mask:hover .icon[data-v-4aee4bda]{display:inline-block;cursor:pointer}.content-component-item-mask-active[data-v-4aee4bda]{border:1px dashed rgba(21,59,184,.3);background:rgba(21,59,184,.05)}.content-component-item-mask-active .icon[data-v-4aee4bda]{display:inline-block;cursor:pointer}.options[data-v-4aee4bda]{width:25%;height:100%;overflow:overlay;background:#fff}", ""]);
// Exports
...
var update = add("ff0b6d74", content, true, {"sourceMap":false,"shadowMode":false});
...
// add the styles to the DOM
var add = (__webpack_require__(7037)/* ["default"] */ .Z)
var update = add("55fe5388", content, true, {"sourceMap":false,"shadowMode":false});
...
var DimpleLowcodevue_type_style_index_0_id_4aee4bda_prod_scoped_true_lang_css_ = __webpack_require__(3207);
;// CONCATENATED MODULE: ./src/package/dimple-lowcode/src/DimpleLowcode.vue?vue&type=style&index=0&id=4aee4bda&prod&scoped=true&lang=css&

// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/package/dimple-lowcode/src/DimpleLowcode.vue?vue&type=style&index=1&id=4aee4bda&prod&lang=css&
var DimpleLowcodevue_type_style_index_1_id_4aee4bda_prod_lang_css_ = __webpack_require__(4731);
;// CONCATENATED MODULE: ./src/package/dimple-lowcode/src/DimpleLowcode.vue?vue&type=style&index=1&id=4aee4bda&prod&lang=css&
